...
class NamedProgram:
    ...
    def runProgram(self, input: ProgramInput, preferredVisualReturnType: Optional[str] = None) -> ProgramOutput:
        ...
        return self.dslProcessor.process(latestCode, input, preferredVisualReturnType)
...
if __name__ == "__main__":
    ...
    programOutput = namedProgram.runProgram(ProgramInput(startTimestamp=0, inputs={}), preferredVisualReturnType="png")
    # Write the visual png to a file
    with open(f"{programName}-output.png", "wb") as f:
